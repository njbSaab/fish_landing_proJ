...
$(document).ready(function () {
	...
	// Запускаем анимацию счетчиков при наличии класса "scrolled" у родителя section
	function checkAndStartCounters() {
		$('section.scrolled').each(function () {
			if ($(this).find('.numbers_items').length > 0) {
				startCounters();
			}
		});
	}
	...
	setInterval(checkAndStartCounters, 4000);
});
